          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl className="mt-10 space-y-4 text-base/7 text-gray-600">
              <div className="flex gap-x-4">
                ...
                <dd>
                  Tầng 2, tòa nhà Trung Yên 1, khu đô thị Trung Yên, Phường Trung Hoà
                  <br />
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="+84 024 710 93 666" className="hover:text-gray-900">
                    +84 024 710 93 666
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:contact@convergedservices.com" className="hover:text-gray-900">
                    contact@convergedservices.com
                  </a>
                </dd>
              </div>
            </dl>
